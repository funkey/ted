#ifndef TED_EVALUATION_TOLERANT_EDIT_DISTANCE_ERRORS_WRITER_H__
#define TED_EVALUATION_TOLERANT_EDIT_DISTANCE_ERRORS_WRITER_H__
...
#endif // TED_EVALUATION_TOLERANT_EDIT_DISTANCE_ERRORS_WRITER_H__
